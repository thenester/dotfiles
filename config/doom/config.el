...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Maple Mono" :size 24))
;;
...
;; Maximize window on the startup
(add-hook 'window-setup-hook 'toggle-frame-maximized t)

;; Activate treesitter by default
...
(map! :leader
      :desc "Format buffer"
      "f m" #'lsp-format-buffer)

;; Theme toggler
(defvar my/theme-dark 'doom-moonlight)
(defvar my/theme-light 'doom-solarized-light)
