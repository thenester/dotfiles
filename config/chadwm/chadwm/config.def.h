...
static const char *fonts[]          = {"Maple Mono:style:medium:size=18" ,"Maple Mono:style:medium:size=18" };
...
static const Key keys[] = {
    ...
    // reboot
    { MODKEY|ControlMask,               XK_x,       spawn,        SHCMD("reboot") },

    // poweroff
    { MODKEY|ControlMask,               XK_z,       spawn,        SHCMD("poweroff") },

    // suspend
    { MODKEY|ControlMask,               XK_c,       spawn,        SHCMD("systemctl suspend") },
